...
%% @doc Check if a document matches raw conditions (without compilation).
%% Convenience function for simple filtering without query planning.
-spec matches(map(), [condition()]) -> boolean().
